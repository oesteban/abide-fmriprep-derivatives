...
performed using *fMRIPrep* 25.2.4
...
BOLD runs were slice-time corrected to the mid-timepoint of each run's slice 
acquisition range using `3dTshift` from AFNI  [@afni, RRID:SCR_005927].
